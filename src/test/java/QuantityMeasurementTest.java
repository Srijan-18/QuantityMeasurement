...
public class QuantityMeasurementTest {
    ...
    public void givenValueInCelsiusAndFahrenheitToCompare_WhenCorrect_ShouldReturnTrue() {
        ...
        Unit fahrenheit = new Unit(212.0, UnitType.FAHRENHEIT);
